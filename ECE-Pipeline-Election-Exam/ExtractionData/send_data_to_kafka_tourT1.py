...
data = pd.read_excel('/Users/surelmanda/Downloads/AirGUARD/Extraction/FichierPipeline/resultats-par-niveau-dpt-t1-france-entiere.xlsx')

# Configure Kafka producer
bootstrap_servers = 'localhost:9092' # Replace with your Kafka bootstrap servers
topic = 'Topic_Resultat_TourT1'     # Replace with your Kafka topic
